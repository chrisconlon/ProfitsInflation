...
├── code/
│   ├── download_data.py          # [Python] Download BEA/Census data to raw_data/ (run once)
...
### 3. Download BEA and Census data

```bash
python code/download_data.py
```

This downloads BEA NIPA tables, GDP-by-Industry gross output, the Census NAICS crosswalk, and Census QFR data into `raw_data/`. Files are only downloaded if they don't already exist. Re-run to pick up updated BEA releases.
